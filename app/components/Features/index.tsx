...
const features = [
  { num: '01', title: 'Gestión de Mesas', desc: 'Active una mesa para generar un ticket nuevo y agregue platillos conforme el cliente ordene. Al pagar, la mesa se desactiva automáticamente.', icon: <><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></> },
  ...
  { num: '05', title: 'Reportes de Ventas', desc: 'Consulte tickets de venta y totales por periodo de fechas. Visualice el rendimiento de su negocio de forma clara y rápida.', icon: <path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/> },
