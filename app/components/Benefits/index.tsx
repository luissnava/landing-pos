...
const benefits = [
  ...
  { icon: <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>, title: 'Soporte en Español', desc: 'Equipo de soporte disponible, para resolver cualquier duda o problema.' },
  { icon: <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>, title: 'Actualizaciones Constantes', desc: 'Mejoras continuas y nuevas funcionalidades incluidas.' },
